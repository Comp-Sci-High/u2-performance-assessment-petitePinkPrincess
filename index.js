...
dishName = dishName.toLocaleLowerCase()
while (dishList.includes(dishName) == false) {
    console.log("Invalid dish name, pls enter the correct one. ")
    dishName = prompt("").toLocaleLowerCase()
}
...
while (true) {
    if (conditionForMeal == "yes") {
        ...
        if (conditionForImage == "yes") {
            ...
            modifiedDishName = modifiedDishName.toLocaleLowerCase()
        ...
        console.log("Invalid response, please enter yes or no to continue: ")
        conditionForMeal = prompt("")
    }
}

console.log("Okay so this is the end of this mealBot, Bon Appetit I guess")